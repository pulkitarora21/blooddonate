...
function(){
if(LivePass.Zn){
uf.zoM(ConvivaNotification.HBx,
"LivePass init times out",null);
...
uf.zoM(ConvivaNotification.bQ,
"Error loading config: "+oL.fg(fe),null);
});
uf.f0();
}else{
...
uf.zoM(ConvivaNotification.vU,
"Error loading module: "+uf.Obu,null);
}
